...
rf_modela <- lmer(correct ~ gender + (1 | StudentID), data=rf_prediction_df)
summary(rf_modela)


dt_modela <- lmer(correct ~ gender + (1 | StudentID), data=dt_prediction_df)
summary(dt_modela)

nn_modela <- lmer(correct ~ gender + (1 | StudentID), data=nn_prediction_df)
summary(nn_modela)

xgb_modela <- lmer(correct ~ gender + (1 | StudentID), data=xgb_prediction_df)
summary(xgb_modela)

dummy_modela <- lmer(correct ~ gender + (1 | StudentID), data=dummy_prediction_df)
...
rf_prediction_a <- lmer(prediction ~ gender + (1 | StudentID), data=rf_prediction_df)
summary(rf_prediction_a)

dt_prediction_a <- lmer(prediction ~ gender + (1 | StudentID), data=dt_prediction_df)
summary(dt_prediction_a)

nn_prediction_a<- lmer(prediction ~ gender + (1 | StudentID), data=nn_prediction_df)
summary(nn_prediction_a)

xgb_prediction_a <- lmer(prediction ~ gender + (1 | StudentID), data=xgb_prediction_df)
summary(xgb_prediction_a)

dummy_prediction_a <- lmer(prediction ~ gender + (1 | StudentID), data=dummy_prediction_df)
